...
vid = Video.create( :url => "[\"/vids/trailer_400p.ogg\",\"/vids/trailer_iphone.m4v\"]", :title =>   "bunny ogg", :owner =>   "Another Programmer", :description =>   "baseline delivery", :delivery  => :baseline, :player =>:html5)
vid = Video.create( :url => "[\"/vids/Chrome_ImF.ogv\",\"/vids/Chrome_ImF.mp4\",\"/vids/Chrome_ImF.webm\"]", :title =>   "google 3 kinds ", :owner =>   "Another Programmer", :description =>   "baseline delivery", :delivery  => :baseline, :player =>:html5)
vid = Video.create( :url => "/vids/trailer_400p.ogg", :title =>   "title", :owner =>   "Another Programmer", :description =>   "send_file delivery", :delivery  => :send_file, :player =>:html5)
...
vid = Video.create( :url => "http://localhost/trailer_400p.ogg", :title =>"video from local url x-accel-redirect", :owner =>   "pretty Secret ", :description =>   "send a priviate file as a private file", :delivery  => :x_accel_redirect, :player =>:html5)
vid = Video.create( :url => "http://localhost/trailer_400p.ogg", :title =>"video from remote url x-accel-redirect_remote", :owner =>   "very Secret Programmer", :description =>   "send a priviate url as a private file", :delivery  => :x_accel_redirect_remote_localhost, :player =>:html5)
vid = Video.create( :url => "[\"/vids/Chrome_ImF.ogv\",\"/vids/Chrome_ImF.mp4\",\"/vids/Chrome_ImF.webm\"]", :title =>   "google 3 kinds ", :owner =>   "Another Programmer", :description =>   "baseline delivery", :delivery  => :x_accel_redirect_remote_localhost, :player =>:html5)
...
vid = Video.create( :url => "/vids/trailer_400p.flv", :title =>   "bunny ogg", :owner =>   "Another Programmer", :description =>   "baseline delivery", :delivery  => :baseline, :player =>:flowplayer)
vid = Video.create( :url => "/vids/trailer_400p.flf", :title =>   "title", :owner =>   "Another Programmer", :description =>   "send_file delivery", :delivery  => :send_file, :player =>:flowplayer)
...
vid = Video.create( :url => "http://localhost/trailer_400p.flv", :title =>"video from local url x-accel-redirect", :owner =>   "pretty Secret ", :description =>   "send a priviate file as a private file", :delivery  => :x_accel_redirect, :player =>:flowplayer)
vid = Video.create( :url => "http://localhost/trailer_400p.flv", :title =>"video from remote url x-accel-redirect_remote", :owner =>   "very Secret Programmer", :description =>   "send a priviate url as a private file", :delivery  => :x_accel_redirect_remote_localhost, :player =>:flowplayer)
